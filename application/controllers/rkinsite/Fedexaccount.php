...
class Fedexaccount extends Admin_Controller {

	public $viewData = array();
	function __construct(){
		parent::__construct();
		$this->viewData = $this->getAdminSettings('submenu','Fedexaccount');
	...
	public function index() {
		...
		$this->viewData['fedexaccountdata'] = $this->Fedexaccount->getFedexAccountByMember();
		$this->admin_headerlib->add_javascript("fedexaccount", "pages/fedexaccount.js");
	...
	public function fedexaccountadd() {
        ...
        $this->admin_headerlib->add_javascript("Fedexaccount", "pages/addfedexaccount.js");
        $this->load->view(ADMINFOLDER . 'template', $this->viewData);
	}
	...
	public function addfedexaccount() {
        ...
        $this->Fedexaccount->_where = "accountnumber='".trim($PostData['accountnumber'])."' OR meternumber='".trim($PostData['meternumber'])."' OR apikey='".trim($PostData['apikey'])."'";
	...
	public function updatefedexaccount() {
		...
		$this->Fedexaccount->_where = "id!=".$FedexaccountID ." AND (accountnumber='".trim($PostData['accountnumber'])."' OR meternumber='".trim($PostData['meternumber'])."' OR apikey='".trim($PostData['apikey'])."')";
        $Count = $this->Fedexaccount->CountRecords();
