...
class Sales_person_member  extends Admin_Controller {
    ...
    function __construct() {
        ...
        parent::__construct();
        $this->viewData = $this->getAdminSettings('submenu', 'Sales_person_member');
    ...
    public function listing() {
        ...
        foreach ($list as $datarow) {         
            ...
            if(in_array($rollid, $edit)) {
                $actions .= '<a class="'.edit_class.'" href="'.ADMIN_URL.'sales-person-member/sales-person-member-edit/'. $datarow->id.'/'.'" title="'.edit_title.'">'.edit_text.'</a>';
            }
            if(in_array($rollid, $delete)) {
                $actions.='<a class="'.delete_class.'" href="javascript:void(0)" title="'.delete_title.'" onclick=deleterow('.$datarow->id.',"","Sales&nbsp;Person&nbsp;'.Member_label.'","'.ADMIN_URL.'sales-person-member/delete-mul-sales-person-member") >'.delete_text.'</a>';
