...
class Website_cart extends Admin_Controller {
    ...
    function __construct(){
        ...
        $this->viewData = $this->getAdminSettings('submenu', 'Website_cart');
    }
    public function index() {
        ...
        if($this->viewData['submenuvisibility']['managelog'] == 1){
            $this->general_model->addActionLog(4,'Website Cart','View website cart.');
        }
        ...
        $this->admin_headerlib->add_javascript("Website_cart", "pages/website_cart.js");
