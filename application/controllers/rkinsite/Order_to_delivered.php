...
class   Order_to_delivered extends Admin_Controller 
{
    public $viewData = array();
    function __construct(){
        parent::__construct();

        $this->viewData = $this->getAdminSettings('submenu', 'Order_to_delivered');
    ...
    public function index(){
        ...
        if($this->viewData['submenuvisibility']['managelog'] == 1){
            $this->general_model->addActionLog(4,'Order To Delivered','View Order To Delivered Report.');
        }
        $this->admin_headerlib->add_javascript_plugins("bootstrap-datepicker","bootstrap-datepicker/bootstrap-datepicker.js");
        $this->admin_headerlib->add_javascript("Order_to_delivered","pages/order_to_delivered.js");
    ...
    {
        if($this->viewData['submenuvisibility']['managelog'] == 1){
            $this->general_model->addActionLog(0,'Order To Delivered','Export to Excel Order To Delivered Report.');
        }
    ...
    function exporttopdfordertodeliveredreport() {
        ...
        if($this->viewData['submenuvisibility']['managelog'] == 1){
            $this->general_model->addActionLog(0,'Order To Delivered','Export to PDF Order To Delivered Report.');
        }
    ...
    public function printordertodeliveredreport(){
        $this->checkAdminAccessModule('submenu','view',$this->viewData['submenuvisibility']);
        if($this->viewData['submenuvisibility']['managelog'] == 1){
            $this->general_model->addActionLog(0,'Order To Delivered','Print Order To Delivered Report.');
        }
