...
class Process extends MY_Controller {
	...
	public function subscribenewsletter()
	{
        ...
        $this->Subscribe->_where = array("email"=>$email,"channelid"=>0,"memberid"=>0,"usertype"=>0);
    ...
    public function searchproduct(){
        ...
        $Data = $this->Product->searchProductByString($PostData['query']);
            ...
            if($Check['channelid']==CUSTOMERCHANNELID){
                if($Check['status']==1){
                    ...
                    if($password!=$Check['password']){
                        ...
                        $userdata = array(
                            base_url().'MEMBER_ID' => $Check['id'],
                            base_url().'MEMBER_NAME' => $Check['name'],
                            base_url().'MEMBER_MOBILENO' => $Check['mobile'],
                            base_url().'MEMBER_EMAIL' => $Check['email'],
                            base_url().'MEMBER_PROFILE_IMAGE' => $Check['image']
                        );
            ...
            if(empty($Checkemail)){  
                ...
                if($RegistraionId){
                    ...
                    $userdata = array(
                        ...
                        base_url().'MEMBER_MOBILENO' => $mobileno,
