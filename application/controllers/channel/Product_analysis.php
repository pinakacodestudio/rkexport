...
class Product_analysis extends Channel_Controller {

    public $viewData = array();
    function __construct(){
        parent::__construct();
        $this->viewData = $this->getChannelSettings('submenu', 'Product_analysis');
    ...
    public function index() {
        ...
        $this->viewData['productdata'] = $this->Product_analysis->getProductListBYSales($MEMBERID);

        $this->channel_headerlib->add_javascript_plugins("bootstrap-datepicker","bootstrap-datepicker/bootstrap-datepicker.js");
        $this->channel_headerlib->add_javascript("product_analysis", "pages/product_analysis.js");
    ...
    public function getproductanalysisdata(){
		...
		$reportdata = $this->Product_analysis->getProductAnalysisData(0,$product,$year,$month,$countryid,$provinceid,$cityid,$MEMBERID,$buyer);
    ...
    public function exporttoexcelproductanalysisreport(){
        ...
        $exportdata = $this->Product_analysis->getProductAnalysisData(0,$product,$year,$month,$countryid,$provinceid,$cityid,$MEMBERID,$buyer);
    ...
    public function exporttopdfproductanalysisreport() {
        ...
        $PostData['reportdata'] = $this->Product_analysis->getProductAnalysisData(0,$product,$year,$month,$countryid,$provinceid,$cityid,$MEMBERID,$buyer);
