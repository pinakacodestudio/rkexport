...
class Import_product_review extends Channel_Controller {

    public $viewData = array();
    function __construct(){
        parent::__construct();
        $this->viewData = $this->getChannelSettings('submenu','Import_product_review');
	...
	public function index() 
	{
        ...
        $this->viewData['importproductreview'] = $this->Import_product_review->getImportProductReview(3,$MEMBERID,$CHANNELID);
        
        $this->channel_headerlib->add_javascript("import_product_review","pages/import_product_review.js");
    ...
    public function import_product_review(){
        ...
        if ($_FILES["importproductreviewfile"]['name'] != '') {
            ...
            if($FileNM !== 0){
                ...
                $file_info_arr=array("employeeid"=>$this->session->userdata(base_url() . 'MEMBERID'),
                                    "file"=>$FileNM,
