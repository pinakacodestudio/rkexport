...
class Advance_payment extends Channel_Controller 
{
    public $viewData = array();
    function __construct(){
    parent::__construct();
        
        $this->viewData = $this->getChannelSettings('submenu', 'Advance_payment');
    ...
    public function index(){
        ...
        $this->channel_headerlib->add_javascript("Advance_payment","pages/advance_payment.js");
