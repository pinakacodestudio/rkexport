...
class Vehicle_insurance extends Channel_Controller {

	public $viewData = array();
	function __construct(){
		parent::__construct();
		$this->viewData = $this->getChannelSettings('submenu','Vehicle_insurance');
	...
	public function index() {
		...
		$this->channel_headerlib->add_javascript("vehicle_insurance","pages/vehicle_insurance.js");
	...
	public function listing() {
        ...
        foreach ($list as $datarow) { 
            ...
            if(in_array($rollid, $edit)) {
                $actions .= '<a class="'.edit_class.'" href="'.CHANNEL_URL.'vehicle-insurance/vehicle-insurance-edit/'. $datarow->id.'/'.'" title="'.edit_title.'">'.edit_text.'</a>';
            }

            if(in_array($rollid, $delete)) {
                $actions.='<a class="'.delete_class.'" href="javascript:void(0)" title="'.delete_title.'" onclick=deleterow('.$datarow->id.',"","Vehicleinsurance","'.CHANNEL_URL   .'vehicle-insurance/delete-mul-Vehicle-insurance") >'.delete_text.'</a>';
	...
	public function vehicle_insurance_add() {
		...
		$this->channel_headerlib->add_javascript("add_vehicle_insurance","pages/add_vehicle_insurance.js");
		$this->load->view(CHANNELFOLDER.'template',$this->viewData);
	}
	...
	public function add_vehicle_insurance() {
		...
		$this->Vehicle_insurance->_where = ("companyname='".$companyname."' AND policyno='".$policyno."' AND vehicleid='".$vehicleid."' AND channelid='".$channelid."' AND memberid='".$memberid."' ");
	...
	public function update_vehicle_insurance() {
		...
		$this->Vehicle_insurance->_where = ("id!='".$insuranceid."' AND companyname='".$companyname."' AND policyno='".$policyno."' AND vehicleid='".$vehicleid."' AND channelid='".$channelid."' AND memberid='".$memberid."' ");
