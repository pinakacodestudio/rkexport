...
class Shiprocket_order extends Channel_Controller {
    ...
    function __construct(){
        ...
        $this->viewData = $this->getChannelSettings('submenu', 'Shiprocket_order');
    }
    public function index() {
        ...
        $this->channel_headerlib->add_javascript("Shiprocket_order", "pages/shiprocket_order.js");
    ...
    public function listing() {
        ...
        $list = $this->Shiprocket_order->get_datatables($MEMBERID,$CHANNELID);
        ...
        foreach ($list as $datarow) {
            ...
            $row[] = '<span class="pull-right"><a href="'.CHANNEL_URL.'invoice/view-invoice/'. $datarow->invoiceid.'/'.'" target="_blank" >'.$datarow->totalrate.'</a></span>';
            ...
            if($datarow->status==1){
                ...
                if($datarow->awb_code==''){
                    ...
                    $generatelabel = $this->Shiprocket_order->generateLabel($datarow->shiprocketshipmentid,$MEMBERID,$CHANNELID);
                    $generatelabel = '{
                        "label_created": 1,
        ...
        $output = array(
                        ...
                        "recordsFiltered" => $this->Shiprocket_order->count_filtered($MEMBERID,$CHANNELID),
                        "data" => $data,
                    );
    ...
    public function order_add() {
        ...
        $pickupdata = $this->Shiprocket_order->pickup_location($MEMBERID,$CHANNELID);
        //print_r($pickupdata);exit;
        ...
        $this->viewData['invoicedata'] = $this->Shiprocket_order->getInvoice($MEMBERID);
        
        $this->channel_headerlib->add_plugin("progress-skylo","progress-skylo/skylo.css");
        $this->channel_headerlib->add_javascript_plugins("progress-skylo","progress-skylo/skylo.js"); 
       
        $this->channel_headerlib->add_javascript("add_shiprocketorder", "pages/add_shiprocketorder.js");
    ...
    public function insert_order(){
        ...
        $createorder = $this->Shiprocket_order->create_order($PostData,$addedby,$CHANNELID);
		...
		$this->readdb->where('type=1 AND thirdparty=1 AND memberid="'.$addedby.'" AND channelid="'.$CHANNELID.'" ');
		$this->readdb->limit(1);
    ...
    public function getCouriercompany(){
        ...
        $couriercompanydata = $this->Shiprocket_order->courier($PostData,$MEMBERID,$CHANNELID);
    ...
    public function cancel_order(){
       ...
       /*  $data = $this->Shiprocket_order->generate_token();
        ...
        $this->Shiprocket_order->cancel_order($shiprocketorderid,$MEMBERID,$CHANNELID);
    ...
    public function generateAwB(){
       ...
       /*  $data = $this->Shiprocket_order->generate_token();
        ...
        $awbdata = $this->Shiprocket_order->generateAwB($shiprocketshipmentid,$MEMBERID,$CHANNELID);
