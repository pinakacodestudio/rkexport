...
//public $user_agent;
	...
	public function __construct() {
        ...
        if (ALLOWS3==1) {
			$this->css_path = AWSLINK.COMMONBUCKETLINK.'/'.CSS_ADMIN_URL; // Set default path to browser specific css files relative to FRONT_URL.
			$this->javascript_path = AWSLINK.COMMONBUCKETLINK.'/'.JS_ADMIN_URL; // Set path to javascripts
			$this->plugin_path = AWSLINK.COMMONBUCKETLINK.'/'.PLUGIN_ADMIN_URL; // Set default path to browser specific css files relative to FRONT_URL.
        }else{
