...
class Member_ajax_pagination{
    ...
    var $uri_segment     = 5;
    var $full_tag_open   = '<ul class="pagination-list">';
    var $full_tag_close  = '<ul>';
    var $first_tag_open  = '<li>';
    var $first_tag_close = '</li>';
    var $last_tag_open   = '<li>';
    var $last_tag_close  = '</li>';
    var $cur_tag_open    = '<li><a href="javascript:void(0)" class="active">';
        ...
        function getData(page){  
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    if('<?php echo $this->target; ?>'=="#productlist"){
                        ...
                        $('html, body').animate({scrollTop: $('#productlist').offset().top - 110}, "slow");
                    }
                    if('<?php echo $this->target; ?>'=="#productreview"){
                        $('html, body').animate({scrollTop: $('.detail .nav').offset().top}, "slow");
                    }
                },
                complete: function(){
                  $('.mask').hide();
