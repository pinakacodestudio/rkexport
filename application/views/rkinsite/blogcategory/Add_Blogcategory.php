		        ...
		        <div class="panel-body">
					...
					<form class="form-horizontal" id="blogcategoryform">
						...
						<div class="form-group" id="name_div">
							<label class="col-sm-3 control-label"> Category Name <span class="mandatoryfield">*</span></label>
							<div class="col-sm-8">
								<input id="name" type="text" name="name" value="<?php if(!empty($blogcategorydatadata)){ echo $blogcategorydatadata['name']; } ?>" class="form-control">
							</div>
						</div>
