		        ...
		        <div class="panel-body">
					...
					<form class="form-horizontal" id="clientform">
						...
						<div class="form-group" id="menuname_div">
							<label class="col-sm-3 control-label">Company Name  <span class="mandatoryfield">*</span></label>
							<div class="col-sm-8">
						...
						<div class="form-group" id="image_div">
						  <label class="col-sm-3 control-label">Cover Image <span class="mandatoryfield">*</span> </label>
						  <div class="col-sm-8">
