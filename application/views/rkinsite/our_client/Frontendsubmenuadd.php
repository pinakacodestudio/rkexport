		        ...
		        <div class="panel-body">
					...
					<form class="form-horizontal" id="frontendsubmenuform">
						...
						<div class="form-group">
							<label for="displayonfront" class="col-sm-3 control-label"></label>
							<div class="col-sm-8">
								<div class="checkbox col-md-5 text-left">
		                          <input id="displayonfront" name="displayonfront"  type="checkbox" <?php if(isset($frontendsubmenudata) && $frontendsubmenudata['displayonfront']==0){ echo ''; }else{ echo 'checked'; }?>>
		                          <label for="displayonfront">Display on Front</label>
								</div>
								<div class="checkbox col-md-6 control-label">
									<input type="checkbox" name="memberheader" id="memberheader" <?php if(!empty($frontendsubmenudata) && $frontendsubmenudata['memberheader']==1){ echo 'checked';}?>>
									<label for="memberheader" style="font-size: 14px;">Display on <?=Member_label?> Header</label>
								</div>
							</div>
						</div>
