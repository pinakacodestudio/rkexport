                  ...
                  <form action="#" id="memberform" class="form-horizontal">
                    <div class="row">
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <div class="col-sm-12">
                            <label for="startdate" class="control-label">Purchase Invoice Date</label>
              ...
              <div class="panel-heading">
                ...
                <div class="col-md-6 form-group" style="text-align: right;">
                  <?php if (strpos(trim($submenuvisibility['submenuadd']),$this->session->userdata[base_url().'ADMINUSERTYPE']) !== false){ ?>
                        <a class="<?=addbtn_class;?>" href="<?=ADMIN_URL?>purchase-invoice/purchase-invoice-add" title=<?=addbtn_title?>><?=addbtn_text;?></a>
                    <?php } ?>
                    <!-- <a class="<?=exportbtn_class;?>" href="javascript:void(0)" onclick="exporttoexcelinvoice()" title="<?=exportbtn_title?>"><?=exportbtn_text;?></a> -->
                </div>
              </div>
              <div class="panel-body no-padding">
                <table id="purchaseinvoicetable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                  <thead>
                    <tr>
