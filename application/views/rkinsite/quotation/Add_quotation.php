                                    ...
                                    <div class="col-sm-<?php if(isset($multiplememberchannel) && $multiplememberchannel==1){ echo "10  pr-n"; }else{ echo "12 pr-sm"; }?>">
                                        ...
                                        <select id="memberid" name="memberid" class="selectpicker form-control" data-live-search="true" data-select-on-tab="true" data-size="8" <?php if(!empty($quotationdata) && !isset($isduplicate)){ echo "disabled"; } ?>>
                                            ...
                                            <?php foreach($memberdata as $member){ ?>
                                                <option data-code="<?=$member['membercode']?>" data-billingid="<?=$member['billingaddressid']?>" data-shippingid="<?=$member['shippingaddressid']?>" value="<?php echo $member['id']; ?>" <?php if(!empty($quotationdata['quotationdetail'])){ if($quotationdata['quotationdetail']['memberid']==$member['id']){ echo "selected"; }} ?>><?php echo ucwords($member['namewithemail']); ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                        ...
                                        <td>
                                            ...
                                            <div class="form-group" id="actualprice<?=($i+1)?>_div">
                                                <div class="col-sm-12">
                                                    ...
                                                    <input type="text" class="form-control actualprice text-right" id="actualprice<?=($i+1)?>" name="actualprice[]" value="<?=$quotationdata['quotationproduct'][$i]['originalprice']?>" onkeypress="return decimal_number_validation(event, this.value, 8);" style="display: block;" div-id="<?=($i+1)?>">
                                                </div>
                                            </div>
                                        </td>
                                        <td>
