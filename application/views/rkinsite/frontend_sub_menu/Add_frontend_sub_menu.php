		        ...
		        <div class="panel-body">
					...
					<form class="form-horizontal" id="frontendsubmenuform">
						...
						<div class="form-group" id="mainmenu_div">
							...
							<div class="col-sm-8">
								<select autofocus id="mainmenu" class="selectpicker form-control" name="mainmenu" data-live-search="true" data-size="8">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								...
								<?php }else{ ?>
									...
									<input type="reset" name="reset" value="RESET" class="btn btn-primary btn-raised" onclick="resetdata()">
								<?php } ?>
								<a class="<?=cancellink_class;?>" href="<?=ADMIN_URL?>frontend-sub-menu" title=<?=cancellink_title?>><?=cancellink_text?></a>
							</div>
						</div>
					</form>
				</div>
