              ...
              <div class="panel-heading">
                ...
                <div class="col-md-6 form-group" style="text-align: right;">
                  <?php 
                    ...
                    ?>
                        <a class="<?=addbtn_class;?>" href="<?=ADMIN_URL?>News/addnews" title=<?=addbtn_title?>><?=addbtn_text;?></a>
                    <?php
                    } if(strpos($submenuvisibility['submenudelete'],','.$this->session->userdata[base_url().'ADMINUSERTYPE'].',') !== false){
                  ?>
                  <a class="<?=deletebtn_class;?>" href="javascript:void(0)" onclick="checkmultipledelete('','News','<?php echo ADMIN_URL; ?>News/deletemulnews')" title=<?=deletebtn_title?>><?=deletebtn_text;?></a>
                  <?php } ?>
                </div>
              </div>
...
function viewmore(id){
  ...
  var uurl = SITE_URL+"News/getnewsdescriptionbyid";
  $.ajax({
    url: uurl,
    type: 'POST',
    data: {id:String(id)},
