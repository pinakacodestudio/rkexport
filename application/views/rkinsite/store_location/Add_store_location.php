						...
						<div class="col-md-12 p-n">
							<div class="col-md-6 p-n">
								<div class="form-group" id="name_div">
									<label for="name" class="col-sm-3 control-label">Store Name <span class="mandatoryfield">*</span></label>
									<div class="col-sm-8">
						...
						<div class="col-md-12 p-n">
							...
							<div class="col-md-6 p-n">
								<div class="form-group" id="mobileno_div">
									<label for="mobileno" class="col-sm-3 control-label">Mobile No. <span class="mandatoryfield">*</span></label>
									<div class="col-sm-8">
						...
						<div class="col-md-12 p-n">
							<div class="col-md-6 p-n">
								<div class="form-group" id="address_div">
									<label for="address" class="col-md-3 control-label">Address <span class="mandatoryfield">*</span></label>
									<div class="col-md-8">
							...
							<div class="col-md-6 p-n">
								<div class="form-group" id="cityid_div">
									<label for="focusedinput" class="col-md-3 control-label">City <span class="mandatoryfield">*</span></label>
									<div class="col-md-8">
						...
						<div class="col-md-12 p-n">
							<div class="col-md-6 p-n">
								<div class="form-group" id="latitude_div">
									<label for="focusedinput" class="col-sm-3 control-label">Latitude <span class="mandatoryfield">*</span></label>
									<div class="col-sm-8">
							...
							<div class="col-md-6 p-n">
								<div class="form-group" id="longitude_div">
									<label  for="focusedinput" class="col-sm-3 control-label">Longitude <span class="mandatoryfield">*</span></label>
									<div class="col-sm-8">
						...
						<div class="col-md-12 p-n">
							<div class="col-md-6 p-n">
									<div class="form-group" id="link_div">
										<label for="link" class="col-sm-3 control-label">Map Link</label>
										<div class="col-sm-8">
						...
						<div class="col-md-12 p-n" style="text-align: center;">
							<div class="form-group">
								...
								<?php }else{ ?>
								  ...
								  <input type="reset" name="reset" value="RESET" class="btn btn-info btn-raised">
								<?php } ?>
                                                <a class="<?=cancellink_class;?>" href="<?=ADMIN_URL?>store-location" title=<?=cancellink_title?>><?=cancellink_text?></a>
							</div>
						</div>	
					</form>
				</div>
