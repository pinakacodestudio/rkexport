                                 ...
                                 <div id="variant_div<?=$k?>">
                                    <div class="col-md-6" style="padding: 0;" id="variants<?=$k?>0">
                                       <div class="col-md-5 pl-xs pr-xs">
                                          <div class="form-group" id="attributediv<?=$k?>0">
                                             <label class="control-label" for="attributeid<?=$k?>0">Attribute <span class="mandatoryfield">*</span></label>
                                       ...
                                       <div class="col-md-5 pl-xs pr-xs">
                                          <div class="form-group" id="variantdiv<?=$k?>0">
                                             <label class="control-label" for="variantid<?=$k?>0">Variant <span class="mandatoryfield">*</span> </label>
                              ...
                              <div class="row m-n">
                                 <div id="variant_div0">
                                    ...
                                    <div class="col-md-6" id="variants00" style="padding: 0;">
                                       <div class="col-md-5 pl-xs pr-xs">
                                          <div class="form-group" id="attributediv00">
                                             <label class="control-label" for="attributeid00"> Attribute <span class="mandatoryfield">*</span></label> 
                                       ...
                                       <div class="col-md-5 pl-xs pr-xs">
                                          <div class="form-group" id="variantdiv00">
                                             <label class="control-label" for="variantid00">Variant <span class="mandatoryfield">*</span></label>
