...
<div class="page-content">
    <div class="page-heading">            
        <h1><?php if(isset($productdata)){ echo 'Edit'; }else{ echo 'Add'; } ?> <?=$this->session->userdata(base_url().'submenuname')?></h1>                    
        <small>
            <ol class="breadcrumb">                        
              ...
              <li class="active"><?php if(isset($productdata)){ echo 'Edit'; }else{ echo 'Add'; } ?> <?=$this->session->userdata(base_url().'submenuname')?></li>
            </ol>
    </small>
    </div>
            ...
            <div class="panel-body">
              <div class="col-sm-12 p-n">
                <form class="form-horizontal" enctype="multipart/form-data" id="productform">
                      ...
                      <div class="col-md-12 p-n"> 
                        <div class="col-md-6 p-n"> 
                          ...
                          <div class="form-group" id="productname_div">
                            <label class="col-sm-3 control-label" for="productname">
                                  Product Name
                            <span class="mandatoryfield"> * </span></label>
                            <div class="col-md-8">
                          ...
                          <div class="col-sm-12"> 
                            ...
                            <div class="col-sm-8 p-n">
                              <div class="form-group" id="prices_div">
                                <!-- <label class="col-sm-3 label-control" for="prices">Price <span class="mandatoryfield"> * </span></label> -->
                                <div class="col-sm-12">
                              ...
                              <div class="form-group" id="price_div">
                                <!-- <label class="col-sm-3 control-label" for="price">
                                 ...
                                 <span class="mandatoryfield"> * </span></label> -->
                                <div class="col-md-12">
                                 <input type="text" id="price" onkeypress="return decimal(event,this.value)" class="form-control" placeholder="Price" name="price" value="<?php if(isset($productdata)){ echo $productdata['price']; } ?>">
                                  </div>
                              </div>
                            </div> 
                      ...
                      <hr/>
                        <div class="col-md-3">
                          <div class="form-group row" for="tax" id="tax_div">
                              <div class="col-sm-12">
                              <label class="label-control" for="tax">
                                    Tax
                               <span class="mandatoryfield"> * </span></label>
                                <input type="text" id="tax" onkeypress="return decimal_number_validation(event,this.value);" class="form-control" placeholder="Tax" name="tax" value="<?php if(isset($productdata)){ echo $productdata['tax']; } ?>">
                              </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                          <div class="form-group" id="hsncode_div">
                            <div class="col-sm-12">
                            <label class="control-label" for="hsncode">
                                  HSN Code
                              <span class="mandatoryfield"> * </span></label>
                              <input type="text" id="hsncode" onkeypress="return isNumber(event)" class="form-control" placeholder="HSN Code" name="hsncode" value="<?php if(isset($productdata)){ echo $productdata['hsncode']; } ?>">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group" id="productsection_div">
                              <div class="col-sm-12">
                              <label class="control-label" for="productsection">
                              Product Section
                              <input type="hidden" value="<?php if(isset($productsectionarr)){ echo implode(",",$productsectionarr); } ?>" name="oldproductsection"></label>
                              <select class="form-control selectpicker" id="productsection" name="productsection[]" title="Select Product Section" multiple>
                                    <?php foreach($productsection as $row){ ?>
                                      <option value="<?php echo $row['id']; ?>" <?php if(isset($productsectionarr)){ if(in_array($row['id'],$productsectionarr)){ echo 'selected'; } } ?>><?php echo $row['name']; ?></option> 
                                      <?php } ?>
                                </select>  
                                </div>
                            </div>
                          ...
                          <div class="form-group" id="stock_div">
                            <div class="col-md-12">
                              <label class="control-label" for="stock">
                                  Stock
                              <span class="mandatoryfield"> * </span></label>
                              <input type="text" id="stock" onkeypress="return isNumber(event)" class="form-control" placeholder="Stock" name="stock" value="<?php if(isset($productdata)){ echo $productdata['universalstock']; } ?>">
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-12">
                        ...
                        <?php if(isset($productdata) && isset($productfile)) { ?>
                          <input type="hidden" name="removeproductfileid" id="removeproductfileid">
                          <script type="text/javascript">var productfilecount=<?=count($productfile)?>;</script>
                              ...
                              <div class="form-group" id="productfile<?=$i+1?>_div">
                                ...
                                <div class="col-md-2">
                                  <?php if($i==0){?>
                                    ...
                                    <?php
                                    if(count($productfile)>1)
                                    {
                                    ?>
                                      <button type="button" class="btn btn-danger btn-raised add_remove_btn_product" onclick="removeproductfile(1)" id=p1 style="padding: 6px 12px;margin-top: 0px;"><i class="fa fa-minus"></i><div class="ripple-container"></div></button>
                                    <?php
                                    }
                                    else
                                    {
                                    ?>
                                      <button type="button" class="btn btn-primary btn-raised add_remove_btn" onclick="addnewproductfile()" id=1 style="padding: 6px 12px;margin-top: 0px;"><i class="fa fa-plus"></i><div class="ripple-container"></div></button>
                                    <?php
                                    }
                                    ?>
                                    
                                  <? }else if($i!=0) { ?>
                                    <button type="button" class="btn btn-danger btn-raised add_remove_btn_product" id="p<?=$i+1?>" onclick="removeproductfile(<?=$i+1?>)" style="padding: 6px 12px;margin-top: 0px;"><i class="fa fa-minus"></i><div class="ripple-container"></div></button>
                                  <? } ?>
                                </div>
                              </div>
                            </div>  
                          <? } ?>
                        <? } else { ?>
                          <script type="text/javascript">var productfilecount=1;</script>
                          <div class="col-md-12 p-n" id="productfilecount1">
                            <div class="form-group" id="productfile1_div">
                              ...
                              <div class="col-md-2">
                                <button type="button" class="btn btn-danger btn-raised add_remove_btn_product" id="p1" onclick="removeproductfile(1)" style="padding: 6px 12px;display: none;"><i class="fa fa-minus"></i><div class="ripple-container"></div></button>
                                <button type="button" class="btn btn-primary btn-raised add_remove_btn" id="1" onclick="addnewproductfile()" style="padding: 6px 12px;margin-top: 0px;"><i class="fa fa-plus"></i><div class="ripple-container"></div></button>
                              </div>
                            </div>
                          </div>  
                        <? } ?>
                      ...
                      <div class="col-md-12">
                        <div class="form-group" id="metatitle_div">
                          ...
                          <div class="col-md-8">
                            <textarea id="metatitle" name="metatitle" class="form-control"><?php if(isset($productdata)){ echo $productdata['metatitle']; } ?></textarea>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="form-group" id="metakeyword_div">
                          <label for="metakeyword" class="col-sm-3 control-label">Meta Keywords</label>
                          <div class="col-sm-8">
                            <input id="metakeyword" type="text" name="metakeyword" value="<?php if(isset($productdata)){ echo $productdata['metakeyword']; } ?>" data-provide="metakeyword">
                          </div>
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="form-group" id="metadescription_div">
                          ...
                          <div class="col-md-8">
                            <textarea id="metadescription" name="metadescription" class="form-control" for="metadescription"><?php if(isset($productdata)){ echo $productdata['metadescription']; } ?></textarea>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-12">
  ...
  function addnewproductfile(){
    ...
    if($('input[name="Filetext[]"]').length<10){
      productfilecount = ++productfilecount;
        $.html = '<div class="col-md-12 p-n" id="productfilecount'+productfilecount+'"><div class="form-group" id="productfile'+productfilecount+'_div"> \
              <div class="col-md-2 text-center"> \
              <img src="<?=DEFAULT_IMG.DEFAULT_IMAGE_PREVIEW?>" id="imagepreview'+productfilecount+'" class="thumbwidth"> \
                ...
                <span class="input-group-btn" style="padding: 0 0px 0px 0px;"> \
                  <span class="btn btn-primary btn-raised btn-file"><i class="fa fa-upload"></i> \
                    <input type="file" name="productfile'+productfilecount+'" class="productfile" id="productfile'+productfilecount+'" accept=".bmp,.bm,.gif,.ico,.jfif,.jfif-tbnl,.jpe,.jpeg,.jpg,.pbm,.png,.svf,.tif,.tiff,.wbmp,.x-png"> \
                  </span> \
                </span> \
              ...
              <div id="youtube'+productfilecount+'" style="display: none;"> \
                <input type="text" id="youtubeurl'+productfilecount+'" class="form-control" name="youtubeurl'+productfilecount+'" onblur="getThumbImage(this.value,\'imagepreview'+productfilecount+'\')"> \
              </div> \
              <input type="hidden" name="filetype'+productfilecount+'" id="imagefile'+productfilecount+'" value="1" checked onclick="filetype('+productfilecount+',1)"> \
                    </div> \
            <div class="col-md-2"> \
              <button type = "button" class = "btn btn-danger btn-raised add_remove_btn_product" id = "p'+productfilecount+'" onclick = "removeproductfile('+productfilecount+')" style = "padding: 6px 12px;"> <i class = "fa fa-minus"> </i><div class="ripple-container"></div></button> \
              <button type="button" class="btn btn-primary btn-raised add_remove_btn" id="'+productfilecount+'" onclick="addnewproductfile('+productfilecount+')" style="padding: 6px 12px;margin-top: 0px;"><i class="fa fa-plus"></i><div class="ripple-container"></div></button> \
            </div> \
                </div></div>';
...
/* 
      ...
      PNotify.removeAll();
      new PNotify({title: 'Maximum 10 files allowed !',styling: 'fontawesome',delay: '3000',type: 'error'});
    }
  }
  ...
  function addproductprice() {
    var pricehtml = '<div class="row"><div class="col-md-7 col-md-offset-3">\
                                 <input type="text" id="prices1" onkeypress="return decimal(event,this.value)" class="form-control" placeholder="Price" name="prices[]" value="<?php if(isset($productdata)){ echo $productdata['price']; } ?>">\
                                  </div>\
                                  <button type="button" class="btn btn-default btn-raised add_remove_price_btn col-md-1" id="pricesbtn1" onclick="addproductprice()"><i class="fa fa-plus"></i></button></div>';
    $("#multipleprices_div").append(pricehtml);
    var last_id=$(".add_remove_price_btn:last").attr("id");
    $("#"+(parseInt(last_id)-1)).attr("onclick","removeproductprice("+(parseInt(last_id)-1)+")");
    $("#"+(parseInt(last_id)-1)).children(":first-child").attr("class","fa fa-minus");
    $("#"+(parseInt(last_id)-1)).children(":first-child").text("");
    $(".add_remove_price_btn:last").attr("onclick","addproductprice()");
    $(".add_remove_price_btn:last").children(":first-child").attr("class","fa fa-plus");
    $(".add_remove_price_btn:last").children(":first-child").html(" <b>1</b>");
  }
