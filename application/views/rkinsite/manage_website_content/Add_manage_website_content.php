		        ...
		        <div class="panel-body">
                  ...
                  <div class="form-group">
                    <div class="col-md-6 form-group m-n p-n" id="title_div">
                      <label for="title" class="col-sm-4 control-label" >Page Title <span class="mandatoryfield">*</span></label>
                      <div class="col-sm-8">
                    ...
                    <div class="col-md-6 form-group m-n p-n" id="slug_div">
                      <label for="slug" class="col-sm-4 control-label"  >Page Link <span class="mandatoryfield">*</span></label>
                      <div class="col-sm-8">
                  ...
                  <div class="form-group">
                    <div class="col-md-6 form-group m-n p-n">
                      <label class="col-sm-4 control-label"  for="focusedinput">Main Menu</label>
                      <div class="col-sm-8">
                    ...
                    <div class="col-md-6 form-group m-n p-n">
                      <label class="col-sm-4 control-label" for="focusedinput">Sub Menu</label>
                      <div class="col-sm-8">
                        <select id="frontendsubmenuid" class="selectpicker form-control" name="frontendsubmenuid" data-live-search="true" data-size="5">
                          ...
                          <?php foreach($frontendsubmenudata as $row){ ?>
                            <option value="<?php echo $row['id']; ?>" <?php if(isset($managewebsitecontentdata)){ if($managewebsitecontentdata['frontendmenuid'] == $row['id']){ echo 'selected'; } } ?>><?php echo $row['name']; ?></option>
                          <?php } ?>
                        </select>
                      </div>
                  ...
                  <div class="form-group">
                    <div class="col-md-6 form-group m-n p-n">
                      <label class="col-sm-4 control-label" for="focusedinput">Footer Section</label>
                      <div class="col-sm-8">
                    ...
                    <div class="col-md-6 form-group m-n p-n">
                      <label  for="focusedinput" class="col-sm-4 control-label" >Class</label>
                      <div class="col-sm-8">
                  ...
                  <div class="form-group" id="metakeywords_div">
                    <label for="focusedinput" class="col-sm-2 control-label" for="metakeywords">Meta Keywords</label>
                    <div class="col-sm-10">
      						...
      						<div class="form-group">
							        ...
							        <div class="col-md-4">
      									...
      									<?php }else{ ?>
      									  ...
      									  <input type="reset" name="reset" value="RESET" class="btn btn-info btn-raised">
                          <?php } ?>
						              <a class="<?=cancellink_class;?>" href="<?=ADMIN_URL?>manage-website-content" title=<?=cancellink_title?>><?=cancellink_text?></a>
      							</div>
      						</div>
                </div>
