...
<div class="page-content">
    <div class="page-heading">            
        ...
        <small>
            ...
            <li class="active"><?php if(isset($invoicedata)){ echo 'Edit'; }else{ echo 'Add'; } ?> <?php echo $this->session->userdata(base_url().'submenuname'); ?></li>
          	</ol>
        </small>
    </div>
		    ...
		    <div class="col-md-12">
		      <div class="panel panel-default border-panel">
		        <div class="panel-body pt-n">
		        	<div class="col-md-12">
						<?php $this->load->view(ADMINFOLDER.'invoice/invoiceformat');?>
					</div>
				</div>
		      </div>
		    </div>
