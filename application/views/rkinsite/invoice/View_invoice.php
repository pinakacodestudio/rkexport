                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-12 text-right">
                                    ...
                                    <a class="<?=printbtn_class;?>" href="javascript:void(0)" onclick="printInvoice(<?=$transactiondata['transactiondetail']['id']?>)" title=<?=printbtn_title?>><?=printbtn_text?></a>
                                    <?php } ?>
                                </div>
                            </div>
						    <?php $this->load->view(ADMINFOLDER.'invoice/Invoiceviewformat');?>
					    </div>
             	    </div>
		        </div>
            </div>
