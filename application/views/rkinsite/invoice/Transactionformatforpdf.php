        ...
        <div class="">
            <div class="panel-body no-padding">
                <div class="table-responsive">
                    <?php $type=1; require_once(APPPATH."views/".ADMINFOLDER.'invoice/Transactionproductdetails.php');?>
                </div>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-md-12">
        ...
        <?php if (isset($printtype) && $printtype!="creditnote" && $transactiondata['transactiondetail']['cashorbankid'] > 0){ ?>
