		        ...
		        <div class="panel-body">
					...
					<form class="form-horizontal" id="socialmediaform">
						...
						<div class="form-group" id="icon_div">
							<label for="icon" class="col-sm-3 control-label">Icon <span class="mandatoryfield">*</span></label>
							<div class="col-sm-8">
						...
						<div class="form-group" id="url_div">
							<label for="url" class="col-sm-3 control-label">Url <span class="mandatoryfield">*</span></label>
							<div class="col-sm-8">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								...
								<?php }else{ ?>
								  ...
								  <input type="reset" name="reset" value="RESET" class="btn btn-info btn-raised" onclick="resetdata()">
								<?php } ?>
								<a class="<?=cancellink_class;?>" href="<?=ADMIN_URL?>socialmedia" title=<?=cancellink_title?>><?=cancellink_text?></a>
							</div>
						</div>
					</form>
				</div>
