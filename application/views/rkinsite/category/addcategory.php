                ...
                <form class="form-horizontal" id="form-category">
                      ...
                      <div class="form-body">
                            <div class="form-group">
                                <label class="col-sm-4 label-control" for="maincategoryid">Choose Section <span class="mandatoryfield"></span></label>
                                <div class="col-sm-8"> 
                            ...
                            <div class="form-group" id="name_div">
                                <label class="col-md-4 label-control" for="name">Category Name <span class="mandatoryfield">*</span></label>
                                <div class="col-md-8">
                                    <input type="text" id="name" class="form-control" placeholder="Category Name" name="name" value="<?php if(isset($categorydata)){ echo $categorydata['name']; } ?>">
                                </div>
                            </div>

                               <div class="form-group" id="image_div">
                                <label class="col-md-4 label-control" for="fileImg">Image File <span class="mandatoryfield">*</span></label>
                                <div class="col-md-8">
