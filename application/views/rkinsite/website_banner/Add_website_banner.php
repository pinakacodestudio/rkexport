		        ...
		        <div class="panel-body">
					...
					<form class="form-horizontal" id="bannerform">
						...
						<div class="form-group" id="title_div">
							<label for="title" class="col-sm-3 control-label">Banner Title <span class="mandatoryfield">*</span></label>
							<div class="col-sm-9">
						...
						<div class="form-group" style="display:none;">
							...
							<div class="col-sm-8">
								<div class="col-sm-3 col-xs-6" style="padding-left: 0px;">
									<div class="radio">
									<input type="radio" name="bannerfiletype" id="imagefile1" value="1" <?php if(isset($bannerdata)){ if($bannerdata['type']==1){ echo 'checked';} }else{ echo 'checked'; }?> onclick="filetype(1,1)">
						...
						<div class="form-group" id="bannerfile_div">               
	                    	...
	                    	<div class="col-sm-9">
	                    		<?php if(isset($bannerdata)){  ?>
	                    			<input type="hidden" name="oldbanner" id="oldbanner"  value="<?=($bannerdata['type']==1 || $bannerdata['type']==2)?$bannerdata['file']:''?>">
							
				         	<input type="hidden" name="removeoldbannerfile" id="removeoldbannerfile" value="0">
						...
						<div class="form-group" id="alttext_div" style="display:<?=(isset($bannerdata) && $bannerdata['type']!=1)?'none':'block'?>;">
							<label for="alttext" class="col-sm-3 control-label">Alt Tag <span class="mandatoryfield">*</span></label>
							<div class="col-sm-9">
						...
						<div class="form-group" id="button_div">
							<label for="buttontext" class="col-sm-3 control-label">Button Name</label>
							<div class="col-sm-9">
						...
						<div class="form-group" id="link_div">
							<label for="link" class="col-sm-3 control-label">Banner Link</label>
							<div class="col-sm-9">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								...
								<?php }else{ ?>
								  ...
								  <input type="reset" name="reset" value="RESET" class="btn btn-info btn-raised">
								<?php } ?>
								<a class="<?=cancellink_class;?>" href="<?=ADMIN_URL?>website-banner" title=<?=cancellink_title?>><?=cancellink_text?></a>
							</div>
						</div>
					</form>
				</div>
