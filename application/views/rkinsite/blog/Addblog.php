		        ...
		        <div class="panel-body">
					...
					<form class="form-horizontal" id="blogform">
						...
						<div class="form-group" id="title_div">
							<label class="col-sm-3 control-label">Blog Title <span class="mandatoryfield">*</span></label>
							<div class="col-sm-8">
						...
						<div class="form-group" id="category_div">
	                  	...
	                  	<div class="form-group" id="metakeywords_div">
							<label for="focusedinput" class="col-sm-3 control-label">Meta Keywords</label>
							<div class="col-sm-8">
