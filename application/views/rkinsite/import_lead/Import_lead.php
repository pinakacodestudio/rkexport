                ...
                <div class="col-md-12">
                    <div class="panel panel-default border-panel mb-md" data-widget="{&quot;draggable&quot;: &quot;false&quot;}" data-widget-static style="visibility: visible; opacity: 1; display: block; transform: translateY(0px);z-index: 9;">
                        ...
                        <div class="panel-body panelcollapse pt-n" style="display: none;">
                            <form action="#" id="importleadform" class="form-horizontal">
                                <div class="col-md-4">
                                    <div class="form-group" id="filetype_div">
                                        <div class="col-sm-12 pl-n pr-sm">
                                            <label class="control-label" for="filetype">File Type <span class="mandatoryfield">*</span></label>
                                            <select id="filetype" name="filetype" class="selectpicker form-control" >
                                                <option value="0">Select File Type</option>
                                                <option value="1">Inquiry Lead File</option>
                                                <option value="2">Facebook Inquiry Lead File</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group" id="importleadfile_div">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-btn" style="padding: 0 0px 0px 0px;">
                                                    <span class="btn btn-primary btn-raised btn-file">Browse...
                                                        <input type="file" name="importleadfile" id="importleadfile" accept="xl,.xlc,.xls,.xlsx,.ods">
                                                    </span>
                                                </span>
                                ...
                                <div class="col-md-12 p-n">                                                   
                                    <a href="<?php echo IMPORT_FILE; ?>lead_import.xls"
                                        class="btn btn-default btn-raised" download="lead_import.xls"><i
                                        class="fa fa-download"></i> Download Sample File</a>
                                    <a href="<?php echo IMPORT_FILE; ?>facebooklead_import.xls"
                                        class="btn btn-default btn-raised" download="facebooklead_import.xls"><i
                                        class="fa fa-download"></i> Download Sample Facebook File</a>
                                </div>
                            </form>
                        </div>
                    </div>
                                ...
                                <div class="tab-content pb-n">
                                    <div class="tab-pane active" id="inquiry">
                                        <table id="inquirytbl" class="table table-striped table-bordered table-responsive-sm"
                                            ...
                                            <tbody>
                                            <?php $i=0;
                                                foreach($importexcellead as $lead){ ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $this->general_model->displaydatetime($lead['createddate']);?></td>                                    
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
                                        </table>
                                    ...
                                    <div class="tab-pane" id="facebook">
                                        <table id="documenttbl" class="table table-striped table-bordered table-responsive-sm" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    <th class="width8">Sr. No.</th>
                                                    <th>Employee</th>
                                            ...
                                            <tbody>
                                            <?php $i=0;
                                                foreach($importfbexcellead as $fblead){ ?>
                                                    <tr>
                                                        <td class="width8"><?php echo ++$i;?></td>
                                                        <td><?php echo ucwords($fblead['name']);?></td>
                                                        <td><?php echo '<a href="'.UPLOADED_IMPORT_EXCEL_FILE.$fblead['file'].'" download="'.$fblead['file'].'" class="a-without-link">'.$fblead['file'].'</a>';?></td> 
                                                        <td><?php echo $fblead['ipaddress'];?></td>                                    
                                                        <td><?php echo $fblead['totalrow'];?></td>
                                                        <td><?php echo $fblead['totalinserted'];?></td>
                                                        <td><?php echo $fblead['totalrow']-$fblead['totalinserted'];?></td>
                                                        <td><?php echo $fblead['info'];?></td>
                                                        <td><?php echo $this->general_model->displaydatetime($fblead['createddate']);?></td>                                    
                                                    </tr>
                                                <?php } ?>
                                            </tbody>
                                        </table>
