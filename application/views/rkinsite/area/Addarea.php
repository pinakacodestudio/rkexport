<script type="text/javascript">
	...
	var provinceid = <?php if(isset($areadata)){ echo $areadata['provinceid'];}else { echo '0'; }?>;
		      ...
		      <div class="panel panel-default">
		        <div class="panel-body">
		        	<div class="col-sm-12 col-md-6 col-lg-6 col-lg-offset-3 col-md-offset-3">
						<form class="form-horizontal" id="areaform" name="areaform">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									...
									<?php }else{ ?>
									  ...
									  <input type="reset" name="reset" value="RESET" class="btn btn-info btn-raised">
									<?php } ?>
									<a class="<?=cancellink_class;?>" href="<?=ADMIN_URL?>area" title=<?=cancellink_title?>><?=cancellink_text?></a>
								</div>
							</div>
						</form>
					</div>
