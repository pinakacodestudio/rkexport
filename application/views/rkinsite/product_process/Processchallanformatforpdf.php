...
<html>
    ...
    <body style="background-color:#FFF;" class="other-pages"> 
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <table style="margin-top:10px;" class="table table-striped table-bordered mb-sm" cellspacing="0" width="100%">
                        ...
                        <?php }else{?>
                            <tr><td colspan="5" style="text-align:center;font-weight:bold;">No data available.</td></tr>
                        <?php } ?>  
                        </tbody>
                    </table>            
                </div>
            ...
            <div class="row mb-xl">
                <div class="col-md-12">
                    <div class="panel-body p-n pt-md pb-xs">
                        ...
                        <div style="margin-right:-25px;margin-top:100px;width:18%;font-size: 12px;color: #000;display: inline-block;float:right">                       
