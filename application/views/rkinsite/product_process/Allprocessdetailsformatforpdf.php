    ...
    <div class="row mb-xl">
        <div class="col-md-12">
            <div class="col-md-12 mb-sm" style="padding: 0px 5px;border: 1px solid #666;">
                <h5><b>Process Group : <?=$productprocessdata['processes'][0]['processgroup']?></b></h5>
            </div>   
            <?php require_once(APPPATH."views/".ADMINFOLDER.'product_process/Allproductprocessdetails.php');?>
        </div>
    </div>
</body>
</html>
