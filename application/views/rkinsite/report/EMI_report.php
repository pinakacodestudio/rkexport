                    ...
                    <div class="col-md-3 col-sm-6">
                      <div class="form-group">
                        <div class="col-md-12 pl-sm pr-sm">
                          ...
                          <select id="paymentstatus" name="paymentstatus" class="selectpicker form-control" data-select-on-tab="true">
            ...
            <div class="panel-heading">
              ...
              <div class="col-md-6 form-group" style="text-align: right;">
                <?php if (in_array("export-to-excel",$this->viewData['thirdlevelsubmenuvisibility']['assignadditionalrights'])){ ?>
                  <a class="<?=exportbtn_class;?>" href="javascript:void(0)" onclick="exportToExcelEMIReport()" title="<?=exportbtn_title?>"><?=exportbtn_text;?></a>
                <?php } if (in_array("export-to-pdf",$this->viewData['thirdlevelsubmenuvisibility']['assignadditionalrights'])){ ?>
                  <a class="<?=exportpdfbtn_class;?>" href="javascript:void(0)" onclick="exportToPDFEMIReport()"  title="<?=exportpdfbtn_title?>"><?=exportpdfbtn_text;?></a>
                <?php } if (in_array("print",$this->viewData['thirdlevelsubmenuvisibility']['assignadditionalrights'])){ ?>
                  <a class="<?=printbtn_class;?>" href="javascript:void(0)" onclick="printEMIReport()" title="<?=printbtn_title?>"><?=printbtn_text;?></a>
                <?php } ?>
              </div>
            </div>
              ...
              <table id="vehicleemitable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                <thead>
                  <tr>
                    ...
                    <th>Vehicle Name</th>
                    <th>Loan Amount (<?=CURRENCY_CODE?>)</th>
