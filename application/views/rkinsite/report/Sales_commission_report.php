                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            ...
                                            <select id="employeeid" name="employeeid" class="selectpicker form-control" data-select-on-tab="true" data-size="8" data-live-search="true" >
                ...
                <div class="panel panel-default border-panel">
                    <div class="panel-heading">
                        ...
                        <div class="col-md-6 form-group" style="text-align: right;">
                            ...
                            <a class="<?=exportbtn_class;?>" href="javascript:void(0)" onclick="exportsalescommissionreport()" title="<?=exportbtn_title?>"><?=exportbtn_text;?></a>
                            <?php } if (in_array("export-to-pdf",$this->viewData['submenuvisibility']['assignadditionalrights'])){ ?>
                            <a class="<?=exportpdfbtn_class;?>" href="javascript:void(0)" onclick="exportsalescommissionreport('pdf')" title="<?=exportpdfbtn_title?>"><?=exportpdfbtn_text;?></a>
                            <?php } if (in_array("print",$this->viewData['submenuvisibility']['assignadditionalrights'])){ ?>
                            <a class="<?=printbtn_class;?>" href="javascript:void(0)" onclick="printsalescommissionreport()" title=<?=printbtn_title?>><?=printbtn_text?></a>
                            <?php } ?>
                        </div>              
                    </div>
                    <div class="panel-body no-padding">
                        <table id="salescommissionreporttable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            <thead>
                                <tr>            
                                    ...
                                    <th><?=Member_label?></th>
                                    <th>Date</th>
                                    <th>Gross Sales (<?=CURRENCY_CODE?>)</th>
                                    <th>Cost (<?=CURRENCY_CODE?>)</th>
                                    <th>Gross Profit (<?=CURRENCY_CODE?>)</th>
                                    <th>GP (%)</th>
                                    <th>Comm. (%)</th>
                                    <th>Comm. (<?=CURRENCY_CODE?>)</th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
