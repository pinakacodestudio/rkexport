                          ...
                          <div class="form-group">
                            <div class="col-md-12 pl-xs pr-xs">
                              ...
                              <select id="type" name="type[]" class="selectpicker form-control" data-select-on-tab="true" data-size="5" data-live-search="true" data-actions-box="true" title="All Transaction Type" multiple>
                                ...
                                <?php } ?>
                                <option value="9">Stock General Voucher (Increment)</option>
                                <option value="10">Stock General Voucher (Decrement)</option>
                              </select>
                            </div>
                          </div>
                        </div>
            ...
            <div class="panel panel-default border-panel">
              <div class="panel-heading">
                ...
                <div class="col-md-6 form-group" style="text-align: right;">
                  ...
                  <a class="<?=exportbtn_class;?>" href="javascript:void(0)" onclick="exporttoexcelproducttransactionreport()" title="<?=exportbtn_title?>"><?=exportbtn_text;?></a>
                  <?php } if (in_array("export-to-pdf",$this->viewData['submenuvisibility']['assignadditionalrights'])){ ?>
                  <a class="<?=exportpdfbtn_class;?>" href="javascript:void(0)" onclick="exporttopdfproducttransactionreport()" title="<?=exportpdfbtn_title?>"><?=exportpdfbtn_text;?></a>
                  <?php } if (in_array("print",$this->viewData['submenuvisibility']['assignadditionalrights'])){ ?>
                  <a class="<?=printbtn_class;?>" href="javascript:void(0)" onclick="printproducttransactionreport()" title=<?=printbtn_title?>><?=printbtn_text?></a>
                  <?php } ?>
                </div>
              </div>
              <div class="panel-body no-padding">
                <table id="producttransactiontable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                  <thead>
                    <tr>            
                      <th>Sr. No.</th>
                      ...
                      <th class="text-right">Per Qty Rate (<?=CURRENCY_CODE?>) </th>
