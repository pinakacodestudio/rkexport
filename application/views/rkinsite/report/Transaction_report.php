      ...
      <div data-widget-group="group1">
        ...
        <div class="col-md-12">
             <div class="panel panel-default border-panel mb-md">
                  ...
                  <form action="#" id="receiptform" class="form-horizontal">
                    <div class="row">
                      <div class="col-md-12">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                          <div class="form-group">
                            <div class="col-md-12 pl-xs pr-xs">
                              <label for="tomemberid" class="control-label">Select Party</label>
            ...
            <div class="panel panel-default border-panel">
              <div class="panel-heading">
                ...
                <div class="col-md-6 form-group" style="text-align: right;">
                  ...
                  <a class="<?=exportbtn_class;?>" href="javascript:void(0)" onclick="exportreceiptreport()" title="<?=exportbtn_title?>"><?=exportbtn_text;?></a>
                  <?php } if (in_array("export-to-pdf",$this->viewData['submenuvisibility']['assignadditionalrights'])){ ?>
                  <a class="<?=exportpdfbtn_class;?>" href="javascript:void(0)" onclick="exporttopdfreceiptreport()" title="<?=exportpdfbtn_title?>"><?=exportpdfbtn_text;?></a>
