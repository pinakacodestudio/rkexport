                            ...
                            <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <div class="col-md-12 pl-xs">
                                                <label for="stocktype" class="control-label">Stock Type</label>
                                                <select id="stocktype" name="stocktype[]" class="selectpicker form-control" data-select-on-tab="true" data-size="5" data-live-search="true" data-live-search="true" data-actions-box="true" title="All Stock Type" multiple>
                                                    <option value="2">Sales Return</option>
                                                    <option value="4">Purchase Return</option>
                                                    <option value="0">Out Process</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-12 p-n">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <div class="col-md-12 pr-xs">
                                                <label for="scraptype" class="control-label">Scrap Type</label>
                                                <select id="scraptype" name="scraptype[]" class="selectpicker form-control" data-select-on-tab="true" data-size="5" data-live-search="true" data-live-search="true" data-actions-box="true" title="All Scrap Type" multiple>
                ...
                <div class="panel panel-default border-panel">
                    <div class="panel-heading p-n">
                        ...
                        <div class="col-md-6 form-group" style="text-align: right;">
                            ...
                            <a class="<?=exportbtn_class;?>" href="javascript:void(0)" onclick="exporttoexcelscrapreport()" title="<?=exportbtn_title?>"><?=exportbtn_text;?></a>
                            <?php } if (in_array("export-to-pdf",$this->viewData['submenuvisibility']['assignadditionalrights'])){ ?>
                            <a class="<?=exportpdfbtn_class;?>" href="javascript:void(0)" onclick="exporttopdfscrapreport()" title="<?=exportpdfbtn_title?>"><?=exportpdfbtn_text;?></a>
                            <?php } if (in_array("print",$this->viewData['submenuvisibility']['assignadditionalrights'])){ ?>
                            <a class="<?=printbtn_class;?>" href="javascript:void(0)" onclick="printscrapreport()" title=<?=printbtn_title?>><?=printbtn_text?></a>
                            <?php } ?>
                        </div>
                    </div>
                    <div class="panel-body no-padding">
                        
                        <table id="scrapreporttable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            <thead>
                                <tr>
