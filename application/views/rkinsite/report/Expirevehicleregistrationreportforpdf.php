        ...
        <table class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
                <tr>
                    ...
                    <th <?=$style?>>Due Date of Registration</th>
                    <!-- <th>Entry Date</th> -->
                    <th <?=$style?>>Days</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr> 
                    ...
                    <td <?=$style?>><?=($row->vehicleno!=''?$row->vehicleno:'-')?></td>
                    <td <?=$style?>><?=($row->vehicletypename!=''?$row->vehicletypename:'-')?></td>
                    <td <?=$style?>><?=($row->ownername!=''?$row->ownername:'-')?></td>
                    <td <?=$style?>><?=($row->ownercontactno!=''?$row->ownercontactno:'-')?></td>
                    <td <?=$style?>><?=($row->duedateofregistration!='0000-00-00'?$this->general_model->displaydate($row->duedateofregistration):'-')?></td>
