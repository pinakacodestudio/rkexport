        ...
        <table class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
                <tr>
                    ...
                    <th class="text-right" <?=$style?>>Loan Amount (<?=CURRENCY_CODE?>)</th>
                    <th <?=$style?>>No. of Installment</th>
            ...
            <tbody>
                ...
                <tr> 
                    ...
                    <td class="text-right" <?=$style?>><?=($row->loanamount!=''?numberFormat($row->loanamount,2,','):'-')?></td>
                    <td <?=$style?>><?=$row->noofinstallment?></td>
                    ...
                    <td <?=$style?>><?=($row->paymentstatus==1)?'Paid':'Pending'?></td>
                    <?php $sr++ ?>
                </tr>
                <?php }
                } ?>
