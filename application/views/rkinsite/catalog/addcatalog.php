                ...
                <form class="form-horizontal" id="form-catalog" enctype="multipart/form-data">
                      ...
                      <div class="form-body">                      
                          ...
                          <div class="form-group row" for="catalogname" id="catalogname_div">
                            <label for="catalogname" class="col-md-3 label-control">
                                  Catalog Name
                            ...
                            <div class="form-group row" id="description_div">
                                <div id='termscontainer'>
                                     <label for="description" class="col-sm-3  label-control">Content Description <span class="mandatoryfield">*</span></label></label>
                                    <div class="col-sm-8">
                            ...
                            <label class="col-md-3 label-control" for="textfile">
                                 Browse Pdf file
                            ...
                            <div class="form-group row" id="fileimage_div">
                                <label class="col-sm-3 label-control">Image File <span class="mandatoryfield">*</span></label>
                                <div class="col-md-8">
