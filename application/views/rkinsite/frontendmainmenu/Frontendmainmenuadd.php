		        ...
		        <div class="panel-body">
					...
					<form class="form-horizontal" id="frontendmenuform">
						...
						<div class="form-group" id="menuname_div">
							<label class="col-sm-3 control-label">Menu Name <span class="mandatoryfield">*</span></label>
							<div class="col-sm-8">
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								...
								<?php }else{ ?>
								  ...
								  <input type="reset" name="reset" value="RESET" class="btn btn-primary btn-raised" onclick="resetdata()">
								<?php } ?>
								<a class="<?=cancellink_class;?>" href="<?=ADMIN_URL?>frontendmainmenu" title=<?=cancellink_title?>><?=cancellink_text?></a>
							</div>
						</div>
					</form>
				</div>
