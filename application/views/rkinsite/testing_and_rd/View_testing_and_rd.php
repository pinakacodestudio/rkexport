                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-12 text-right">
                                    ...
                                    <a class="<?=printbtn_class;?>" href="javascript:void(0)" onclick="printTesting(<?=$id?>)" title=<?=printbtn_title?>><?=printbtn_text?></a>
                                    <a class="<?=exportpdfbtn_class;?>" href="javascript:void(0)" onclick="$.skylo('end');window.location= SITE_URL+'testing-and-rd/exporttopdfTestingandrdDetails?testingid=<?=$id?>'" title=<?=exportpdfbtn_title?>><?=exportpdfbtn_text?></a>
                                    
                                </div>
                            </div>
						    <?php $this->load->view(ADMINFOLDER.'testing_and_rd/Viewtestingandrdformat');?>
					    </div>
             	    </div>
		        </div>
            </div>
