		      ...
		      <div class="panel panel-default">
		        <div class="panel-body">
                    <div class="col-md-12">
                        ...
                        <?php require_once(APPPATH."views/".ADMINFOLDER.'purchase_quotation/Purchasequotationviewformat.php');?>
                    </div>
                    <?php if(count($installment)>0){ ?>
                        <div class="col-md-12">
                    ...
                    <?php } ?>
                    <?php if(count($transactionattachment)>0){ ?>
                        <div class="col-md-12">
                            <div class="panel border-panel mb-xl">
                                <div class="panel-heading">
                    ...
                    <?php } ?>
                    <?php if(!empty($quotationstatushistory) && count($quotationstatushistory)>0){ ?>
                        <div class="col-md-12">
