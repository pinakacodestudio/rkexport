                                ...
                                <div class="form-group">
                                  <div class="col-sm-12 pr-sm">
                                        ...
                                        <div class="input-daterange input-group" id="datepicker-range">
                                            <input type="text" class="input-small form-control" name="fromdate" id="fromdate" value="<?php echo $this->general_model->displaydate(date("y-m-d",strtotime("-12 month"))); ?>" placeholder="Start Date" title="Start Date" readonly/>
          ...
          <div class="col-md-12">
            <div class="panel panel-default border-panel">
              ...
              <div class="panel-body no-padding">
                <table id="paymentcollectiontable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                  <thead>
                    <tr>            
                      <th>Invoice No.</th>
                      <th>Employee</th>
                      <th><?=Member_label?></th>
                      <th>Collected Amt (<?=CURRENCY_CODE?>)</th>
                      <th>Invoice Amt (<?=CURRENCY_CODE?>)</th>
                      <th>Type</th>
