                        ...
                        <div class="form-group">
                          <div class="col-sm-12">
                            ...
                            <select id="status" name="status" class="selectpicker form-control" data-select-on-tab="true" data-size="5">
                              ...
                              <option value="0" <?=(isset($orderstatus) && $orderstatus==0)?"selected":"";?>>Pending</option>
                              <option value="3" <?=(isset($orderstatus) && $orderstatus==3)?"selected":"";?>>Partially</option>
                              <option value="1" <?=(isset($orderstatus) && $orderstatus==1)?"selected":"";?>>Complete</option>
                              <option value="2" <?=(isset($orderstatus) && $orderstatus==2)?"selected":"";?>>Cancel</option>
                            </select>
                          </div>
                        </div>
                      </div>
                ...
                <div class="col-md-6 form-group" style="text-align: right;">
                  <?php 
                    if (strpos($submenuvisibility['submenuadd'],','.$this->session->userdata[base_url().'ADMINUSERTYPE'].',') !== false){ ?>
                      <a class="<?=addbtn_class;?>" href="<?=ADMIN_URL?>shiprocket_order/order-add" title=<?=addbtn_title?>><?=addbtn_text;?></a>
                  <?php
                    } ?>
                </div>
              </div>
