          ...
          <div class="col-md-12">
            <div class="panel panel-default border-panel">
                ...
                <div class="col-md-8 p-n" style="text-align: right;">
                  <?php 
                    if (strpos($submenuvisibility['submenuadd'],','.$this->session->userdata[base_url().'ADMINUSERTYPE'].',') !== false){ ?>
                      <a class="<?=addbtn_class;?>" href="<?=ADMIN_URL?>todo-list/todo-list-add" title=<?=addbtn_title?>><?=addbtn_text;?></a>
                  <?php
                    } ?>
                    <?php
                    if(strpos($submenuvisibility['submenudelete'],','.$this->session->userdata[base_url().'ADMINUSERTYPE'].',') !== false){
                  ?>
                  <a class="<?=deletebtn_class;?> delete-btn-align" href="javascript:void(0)" onclick="checkmultipledelete('<?php echo ADMIN_URL; ?>todo-list/check-todo-list-use','To&nbsp;Do&nbsp;List','<?php echo ADMIN_URL; ?>todo-list/delete-mul-todo-list')" title=<?=deletebtn_title?>><?=deletebtn_text;?></a>
                  <?php } ?>
                  
                  <a class="<?=addbtn_class; ?> delete-btn-align " href="javascript:void(0)" onclick="setorder('<?=ADMIN_URL; ?>todo-list/updatepriority')" id="btntype" title="SET PRIORITY">Set Priority</a>
              ...
              <div class="panel-body no-padding">
                <table id="todolist" class="table table-striped table-bordered" cellspacing="0" width="100%">
                  <thead>
                    <tr>            
