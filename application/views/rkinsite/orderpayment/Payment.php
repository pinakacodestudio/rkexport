            ...
            <div class="panel panel-default border-panel">
              <div class="panel-heading">
                ...
                <div class="col-md-6 form-group" style="text-align: right;">
                    ...
                    ?>
                    <a class="<?=addbtn_class;?>" href="<?php echo ADMIN_URL; ?>OrderPayment/payment-add" title=<?=addbtn_title?>><?=addbtn_text;?></a>
                    <?php
                        }if(strpos(trim($submenuvisibility['submenudelete'],','),$this->session->userdata[base_url().'ADMINUSERTYPE']) !== false){
                    ?>
                    <a class="<?=deletebtn_class;?>" href="javascript:void(0)" onclick="checkmultipledelete('','Payment','<?php echo ADMIN_URL; ?>OrderPayment/delete-mul-payment')" title=<?=deletebtn_title?>><?=deletebtn_text;?></a>
                    <?php } ?>
                </div>
              </div>
