                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-12 text-right">
                                    ...
                                    <a class="<?=printbtn_class;?>" href="javascript:void(0)" onclick="printPayment(<?=$paymentreceiptdata['paymentreceiptdetail']['id']?>)" title=<?=printbtn_title?>><?=printbtn_text?></a>
                                    <?php } ?>
                                </div>
                            </div>
						    <?php $this->load->view(ADMINFOLDER.'payment/Paymentviewformat');?>
					    </div>
             	    </div>
		        </div>
            </div>
