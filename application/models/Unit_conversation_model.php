...
class Unit_conversation_model extends Common_model {
	...
	public $column_order = array(null,'productname');
	// ,'inputunitname','uc.inputunitvalue','outputunitname','uc.outputunitvalue','uc.createddate'
	//set column field database for datatable searchable 
	// '(SELECT name FROM '.tbl_productunit.' WHERE id=uc.inputunitid)','uc.inputunitvalue','(SELECT name FROM '.tbl_productunit.' WHERE id=uc.outputunitid)','uc.outputunitvalue',
	public $column_search = array('p.name','uc.createddate');
