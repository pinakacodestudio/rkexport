...
class Lead_source_model extends Common_model {

	//put your code here
	public $_table = tbl_leadsource;
	public $_fields = "*";
	public $_where = array();
	...
	public $order = "name ASC"; // default order 

	function __construct() {
		parent::__construct();
	}
	
	function getLeadsource($id=0) {
	...
	function _get_datatables_query(){
		...
		$this->readdb->select("id,name,color,status");
	    $this->readdb->from($this->_table);
		$i = 0;
	...
	function getActiveLeadsourceList() {
