...
class Import_product_review_model extends Common_model {
    ...
    public function getImportProductReview($importfrom=3,$MEMBERID=0,$CHANNELID=0) {
        ...
        $query = $this->readdb->select("u.name,ile.id as ieid,ile.file,ile.ipaddress,ile.info,ile.totalrow,ile.totalinserted,ile.createddate")
                    ...
                    ->where("ile.importfrom = '".$importfrom."' AND ile.memberid='".$MEMBERID."' AND ile.channelid='".$CHANNELID."'")
