...
class Member_rating_status_model extends Common_model {

	//put your code here
	public $_table = tbl_memberratingstatus;
	public $_fields = "*";
	public $_where = array();
	...
	function getRatingstatusDataByID($ID){
		$query = $this->readdb->select("id,name,status,color")
							->from($this->_table)
							->where("id", $ID)
							->get();
	...
	function getActiveRatingstatusData(){
