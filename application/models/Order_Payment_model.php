...
class Order_Payment_model extends Common_model {
	...
	public $column_order = array(null,'transactiontype','pr.amount'); //set column field database for datatable orderable
