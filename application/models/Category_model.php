...
class Category_model extends Common_model {
	...
	function _get_datatables_query($MEMBERID,$CHANNELID){
		...
		$this->readdb->select('pc1.id,pc1.name,DATE_FORMAT(pc1.createddate, "%d/%m/%Y %H:%i:%s") as date,pc1.status,(select name from '.tbl_productcategory.' as pc2 where pc2.id=pc1.maincategoryid)as maincategoryname,pc1.priority,pc1.addedby,pc1.usertype');
