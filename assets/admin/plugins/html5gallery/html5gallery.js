...
function loadHtml5Gallery(u) {
    ...
    jQuery.extend(jQuery.easing, {
        ...
        easeInOutElastic: function(b, e, a, c, d) {
            ...
            h || (h = d * 0.3 * 1.5);
            f < Math.abs(c) ? (f = c, b = h / 4) : b = h / (2 * Math.PI) * Math.asin(c / f);
            return 1 > e ? -0.5 * f * Math.pow(2, 10 * (e -= 1)) * Math.sin((e * d - b) * 2 * Math.PI / h) + a : 0.5 * f * Math.pow(2, -10 * (e -= 1)) * Math.sin((e * d - b) * 2 * Math.PI /
                h) + c + a
        },
    ...
    s.fn.touchSwipe = function(b) {
        ...
        return this.each(function() {
            ...
            function d(a) {
                if (0 < l || 0 < g) 100 < Math.abs(l - f) && (l > f ? e.swipeRight && e.swipeRight.call() : e.swipeLeft && e.swipeLeft.call()), 100 < Math.abs(g - j) && (g > j ?
        ...
        k = x.drag = {
            ...
            handler: function(b) {
                ...
                switch (b.type) {
                    ...
                    case "mouseup":
                        t.remove(document, "mousemove mouseup", k.handler), e.dragging && (!1 !== e.drop && x.drop && x.drop.handler(b, e),
            ...
            hijack: function(b, e, a, c, d) {
                if (a) {
                    ...
                    a.results = [];
                    do
                        if ((v = a.interactions[g]) && !("dragend" !== e && v.cancelled)) r = k.properties(b, a, v), v.results = [], m(d || v[j] || a.droppable).each(function(c, d) {
                            r.target = d;
                            l = t.handle ? d ? t.handle.call(d, b, r) : null : d ? t.dispatch.call(d, b, r) : null;
                            !1 === l ? ("drag" == j && (v.cancelled = !0, a.propagates -= 1), "drop" == e && (v[j][c] = null)) :
                                "dropinit" == e && v.droppable.push(k.element(l) || d);
                            "dragstart" == e && (v.proxy = m(k.element(l) || v.drag)[0]);
                            v.results.push(l);
                            delete b.result;
                            if ("dropinit" !== e) return l
                        }), a.results[g] = k.flatten(v.results), "dropinit" == e && (v.droppable = k.flatten(v.droppable)), "dragstart" == e && !v.cancelled && r.update(); while (++g < c);
                    b.type = f;
                    b.originalEvent = h;
            ...
            textselect: function(b) {
                m(document)[b ? "unbind" : "bind"]("selectstart", k.dontstart).attr("unselectable",
    ...
    A.fn.html5boxTransition = function(b, e, a, c, d) {
        ...
        l && c[l] && ("duration" in
            c[l] && (f = c[l].duration), c[l].easing && (h = c[l].easing));
    ...
    n.fn.addHTML5VideoControls = function(b, e, a, c, d, h, f, j, l) {
        ...
        c || setInterval(function() {
            x && (w.show(), x = !1, clearTimeout(t), t = setTimeout(function() {
                q.get(0).paused || w.fadeOut()
            }, 5E3))
        }, 250);
        n(".html5boxVideoControlsBg", w).css({
            display: "block",
            position: "absolute",
            width: "100%",
            height: "100%",
        ...
        var U = n(".html5boxTimeCurrent",
                w),
            G = n(".html5boxTimeTotal", w),
            C = n(".html5boxSeeker", w),
            O = n(".html5boxSeekerPlay", w),
            P = n(".html5boxSeekerBuffer", w),
            L = n(".html5boxSeekerHandler", w);
        U.css({
            display: "block",
            position: "relative",
            "float": "left",
        ...
        if (y.get(0).requestFullscreen || y.get(0).webkitRequestFullScreen || y.get(0).mozRequestFullScreen || y.get(0).webkitEnterFullScreen || y.get(0).msRequestFullscreen) {
            var H = function(a) {
                f ? a ? (q.get(0).setAttribute("controls", "controls"), j && q.get(0).setAttribute("controlsList", "nodownload")) : q.get(0).removeAttribute("controls") :
                    a ? (n(document).on("mousemove", N), w.css({
                        "z-index": 2147483647,
                        position: "fixed"
                    }), E.css({
                        "z-index": 2147483647,
                        ...
                        "z-index": 2147483647
                    })) : (n(document).off("mousemove", N), w.css({
                        "z-index": "",
                        position: "absolute"
                    }), E.css({
                        "z-index": "",
        ...
        if (q.get(0).volume === a / 2 + 0.1) {
            q.get(0).volume = a;
            h = n(".html5boxVolume", w);
            var V = n(".html5boxVolumeButton", w),
                Y = n(".html5boxVolumeBar", w),
                J = n(".html5boxVolumeBarBg", w),
                Q = n(".html5boxVolumeBarActive", w);
            h.css({
                display: "block",
                position: "relative",
                "float": "right",
            ...
            J.on(v, function(a) {
                a = 1 - ((g ? a.originalEvent.touches[0] : a).pageY - J.offset().top) / J.height();
                a = 1 < a ? 1 : 0 > a ? 0 : a;
                Q.css({
                    height: Math.round(100 * a) + "%"
                });
        ...
        b = function() {
            d || B.show();
            c || (w.show(), clearTimeout(t), K.show(), p.hide())
        };
        v = function() {
        ...
        try {
            q.on("play", function() {
                d || B.hide();
                c || (K.hide(), p.show())
            }), q.on("pause", b), q.on("ended", v), q.on("timeupdate", k), q.on("progress", m)
        } catch (ba) {}
    };
    var b = jQuery,
        F = 0;
    b.fn.html5gallery = function(k) {
        ...
        e.prototype = {
            ...
            init: function(a) {
                ...
                a.options.fv ? a.options.watermarkcode =''/*a.options.watermarkcode = "<a style='text-decoration:none;' target='_blank' href='" + a.options.freelink + "' >"*/ : 0 < a.options.watermarklink.length && (a.options.watermarkcode = "<a style='text-decoration:none;' target='_blank' href='" + a.options.watermarklink + "' >");
               /* a.options.watermarkcode += "<div " + (a.options.fv ? "" : "class='html5gallery-watermark-" + a.id + "' ") + "style='" + (a.options.fv ? "display:block;visibility:visible;position:absolute;top:10px;left:10px;width:170px;height:18px;line-height:18px;text-align:center;border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px;background-color:#fff;color:#333;font-size:12px;font-family:Arial,Helvetica,sans-serif;" :
                ...
                a.options.fv ? a.options.watermarkcode += a.options.fvm : 0 < a.options.watermark.length && (a.options.watermarkcode += "<img src='" + a.options.watermark + "' alt='' />");
                ...
                if (!(0 >= a.elemArray.length)) {
                    ...
                    c.html5galleryid && c.html5galleryid in a.elemArray && (d = c.html5galleryid);
                    c.galleryshareid && c.galleryshareid in a.elemArray && (d = c.galleryshareid);
                    a.slideRun(d);
            ...
            checkMK: function() {
                if (this.options.fv) {
                    ...
                    //var c = b('a[href="' + this.options.freelink + '"]', a);
                    var c = '';
            ...
            readTags: function() {
                ...
                (b("img.html5galleryimg", this.container).length ? b("img.html5galleryimg", this.container) : b("img", this.container)).each(function() {
                    ...
                    b(this).parent().is("a") && (d = b(this).parent().attr("href"), v = b(this).parent().data("ogg"), r = b(this).parent().data("webm"), k = b(this).parent().data("link"), m = b(this).parent().data("linktarget"), n = b(this).parent().data("poster"), isNaN(b(this).parent().data("width")) || (j = b(this).parent().data("width")), isNaN(b(this).parent().data("height")) || (l = b(this).parent().data("height")), s = b(this).parent().data("hd"), t = b(this).parent().data("hdogg"), u = b(this).parent().data("hdwebm"),
                        x = b(this).parent().data("lightboxwidth"), A = b(this).parent().data("lightboxheight"), F = b(this).parent().data("youtubeapikey"), q = b(this).parent().data("youtubeplaylistid"), B = b(this).parent().data("youtubeplaylistmaxresults"), E = b(this).parent().hasClass("html5gallerylightbox"));
                    var w = b(this).parent().data("mediatype") ? b(this).parent().data("mediatype") : a.checkType(d);
                    a.elemArray.push([a.elemArray.length, c, d, v, r, k, m, e, f, w, j, l, n, s, t, u, g, x, A, F, q, B, E])
                })
            },
            getYouTubePlaylist: function(a, c, d, e, f, j, l) {
                0 <= e &&
                    j.elemArray.splice(e, 1);
                ...
                b.getJSON(g, function(b) {
                    ...
                    b && (b.nextPageToken && d && 50 < d) && (v = !1, j.getYouTubePlaylist(a, c, d - 50, e, f, j, b.nextPageToken))
                }).always(function() {
                    v && f(j)
                })
            },
                ...
                if (this.container.parent() &&
                    ...
                    if (1 == a || this.showingPoster) {
                        ...
                        b(".html5gallery-elem-video-" + this.id).css({
                            ...
                            width: d + "px",
                            height: c + "px"
                        }), b("#html5gallery-elem-video-" + this.id).attr("width", d), b("#html5gallery-elem-video-" + this.id).attr("height", c), b(".html5gallery-elem-video-" + this.id).find("iframe").attr("width",
                            d), b(".html5gallery-elem-video-" + this.id).find("iframe").attr("height", c), b("#html5gallery-elem-video-" + this.id).find("iframe").attr("width", d), b("#html5gallery-elem-video-" + this.id).find("iframe").attr("height", c), b(".html5gallery-elem-iframe-" + this.id).css({
                            width: d + "px",
                            height: c + "px"
                        }), b(".html5gallery-elem-iframe-" + this.id).find("iframe").attr("width", d), b(".html5gallery-elem-iframe-" + this.id).find("iframe").attr("height", c);
                    e = d = 0;
                    "bottom" == this.options.headerpos && (d = this.options.titleoverlay ?
                        this.options.height - this.options.titleheight : this.options.height, e = this.options.titleoverlay ? this.options.height : this.options.height + this.options.titleheight);
                ...
                if (this.container.parent() && this.container.parent().width()) {
                    ...
                    if (1 == a || this.showingPoster) {
                        ...
                        b(".html5gallery-elem-video-" + this.id).css({
                            ...
                            width: e + "px",
                            height: a + "px"
                        }), b("#html5gallery-elem-video-" + this.id).attr("width", e), b("#html5gallery-elem-video-" + this.id).attr("height", a), b(".html5gallery-elem-video-" + this.id).find("iframe").attr("width",
                            e), b(".html5gallery-elem-video-" + this.id).find("iframe").attr("height", a), b("#html5gallery-elem-video-" + this.id).find("iframe").attr("width", e), b("#html5gallery-elem-video-" + this.id).find("iframe").attr("height", a), b(".html5gallery-elem-iframe-" + this.id).css({
                            width: e + "px",
                            height: a + "px"
            ...
            loadCarousel: function() {
                ...
                for (var d = 0; d < this.elemArray.length; d++) {
                    var e = b("<div " + (this.options.enabletabindex ? "tabindex='0' " : "") + "id='html5gallery-tn-" + this.id + "-" + d + "' class='html5gallery-tn-" +
                    ...
                    b(e).on("load", function() {
                        ...
                        var d = Math.max(a.options.thumbimagewidth / this.width, a.options.thumbimageheight / this.height),
                            ...
                            h = a.options.thumbshowplayonvideo && 1 != a.elemArray[this.data][9] ? "<div class='html5gallery-tn-img-play-" + a.id + "' style='display:block; overflow:hidden; position:absolute; width:100%;height:100%; top:" +
                        ...
                        a.options.carouselmultirows && "samecolumn" == a.options.thumbresponsive ? b("#html5gallery-tn-" + a.id + "-" + this.data, c).append("<div class='html5gallery-tn-img-" + a.id + "'" + g + " style='position:relative;width:" + String(a.options.thumbimagewidth + 2 * a.options.thumbimageborder) +
            ...
            goNormal: function() {
                ...
                if (0 < b(".html5gallery-elem-" + this.id,
                        this.$fullscreen).length) {
            ...
            calcIndex: function(a) {
                this.savedElem = this.curElem; - 2 == a ? (this.nextElem = this.curElem, this.curElem = this.prevElem, this.prevElem = 0 > this.curElem - 1 ? this.elemArray.length - 1 : this.curElem - 1) : -1 == a ? (this.prevElem = this.curElem, this.curElem = this.nextElem, this.nextElem = this.curElem + 1 >= this.elemArray.length ? 0 : this.curElem + 1) : 0 <= a && (this.curElem = a, this.prevElem = 0 > this.curElem -
                    1 ? this.elemArray.length - 1 : this.curElem - 1, this.nextElem = this.curElem + 1 >= this.elemArray.length ? 0 : this.curElem + 1)
            },
            showSlideTimer: function() {
                var a = this.elemArray[this.curElem][16] ? this.elemArray[this.curElem][16] : this.options.slideshowinterval;
                this.slideTimerCount++;
                this.isFullscreen ? b(".html5gallery-fullscreen-timer-" + this.id, this.$fullscreen).width(Math.round(50 * b(".html5gallery-fullscreen-elem-wrapper-" + this.id, this.$fullscreen).width() * (this.slideTimerCount + 1) / a)) : b(".html5gallery-timer-" + this.id,
                    this.$gallery).width(Math.round(50 * this.options.boxWidth * (this.slideTimerCount + 1) / a))
            },
            setHd: function(a, b) {
            ...
            slideRun: function(a, c, d, e) {
                ...
                this.calcIndex(a);
                this.options.socialurlforeach && this.createSocialMedia();
                !this.isFullscreen && this.options.showcarousel && (b("#html5gallery-tn-" + this.id + "-" + this.curElem, this.$gallery).removeClass("html5gallery-tn-" + this.id).addClass("html5gallery-tn-selected-" + this.id), !this.options.notupdatecarousel && !this.disableupdatecarousel &&
                    this.carouselHighlight(this.curElem));
                if (this.options.showtitle || this.options.lightboxshowtitle || this.options.lightboxshowdescription) {
                    ...
                    if (this.isFullscreen) {
                        ...
                        this.options.lightboxshowdescription && f && (j += "<div class='html5gallery-fullscreen-description-" +
                            this.id + "'>" + f + "</div>");
                        b(".html5gallery-fullscreen-title-" + this.id, this.$fullscreen).html(j)
                    } else this.options.showtitle && (j = "", a && (j += ""), this.options.showdescription && f && (j += "<div class='html5gallery-description-text-" + this.id + "'>" + f + "</div>"), b(".html5gallery-title-" + this.id, this.$gallery).html(j));
            ...
            adjustFullscreen: function(a, c, d) {
                ...
                var j = Math.max(f, b(document).height()),
                    l = this.elemArray[this.curElem][17] ? Math.min(this.elemArray[this.curElem][17],
                ...
                b("#html5gallery-elem-video-" + this.id, this.$fullscreen).find("iframe").attr("width", a);
                b("#html5gallery-elem-video-" + this.id, this.$fullscreen).find("iframe").attr("height", c);
                b(".html5gallery-elem-iframe-" + this.id,
                    this.$fullscreen).css({
                    width: a + "px",
                    height: c + "px"
                });
            ...
            showPoster: function() {
                ...
                b(j).on("load", function() {
                    ...
                    var j, g, k;
                    d.isFullscreen ? (g = d.elemArray[d.curElem][17] ? Math.min(d.elemArray[d.curElem][17], d.fullscreenWidth) : Math.min(e, d.fullscreenWidth), k = d.elemArray[d.curElem][18] ? Math.min(d.elemArray[d.curElem][18], d.fullscreenHeight) : Math.min(f, d.fullscreenHeight), j = Math.max(g / this.width, k / this.height),
                        j = 1 < j ? 1 : j) : (j = "fill" == d.options.resizemode ? Math.max(d.options.width / this.width, d.options.height / this.height) : Math.min(d.options.width / this.width, d.options.height / this.height), g = d.options.width, k = d.options.height);
                    ...
                    g = b("<div class='html5gallery-elem-img-" + d.id + "' style='display:block; position:absolute; overflow:hidden; width:" +
                        ...
                        m + "px; height:" + j + "px;' src='" + d.elemArray[d.curElem][12] + "' />" + d.options.watermarkcode + "</div>");
                    ...
                    if (!b(".html5gallery-video-play-" + d.id, a).length) b("<div class='html5gallery-video-play-" + d.id + "' style='position:absolute;display:block;cursor:pointer;top:50%;left:50%;width:64px;height:64px;margin-left:-32px;margin-top:-32px;background:url(\"" +
                        d.options.playvideoimage + "\") no-repeat center center;'></div>").appendTo(c).off(d.eClick).on(d.eClick, function() {
                ...
                b(j).on("error",
                    function() {
                        ...
                        d.options.googleanalyticsaccount && window._gaq && window._gaq.push(["_trackEvent", "Image",
                            "Error", d.elemArray[d.curElem][12]
                        ])
                    });
            ...
            playVideo: function() {
                ...
                if (5 == a || 6 == a || 7 == a || 8 == a) this.isHTML5 && 0 < b("#html5gallery-elem-html5-video-" + this.id).length ? b("#html5gallery-elem-html5-video-" +
                    this.id, this.container).get(0).play() : (a = this.getFlashMovieObject("html5gallery-elem-video-flash-" + this.id)) && "function" === typeof a.playVideo && a.playVideo()
            },
                ...
                if ("undefined" !== typeof html5GalleryObjects && html5GalleryObjects && html5GalleryObjects.objects)
                    for (var a = 0; a < html5GalleryObjects.objects.length; a++)
                        if (html5GalleryObjects.objects[a].id != this.id) try {
                            html5GalleryObjects.objects[a].ytPlayer &&
                                "function" == typeof html5GalleryObjects.objects[a].ytPlayer.pauseVideo && html5GalleryObjects.objects[a].ytPlayer.pauseVideo(), html5GalleryObjects.objects[a].vimeoPlayer && html5GalleryObjects.objects[a].vimeoPlayer.api("pause")
                        } catch (c) {}
            },
            pauseVideo: function() {
                var a = this.elemArray[this.curElem][9];
                5 == a || 6 == a || 7 == a || 8 == a ? this.isHTML5 && 0 < b("#html5gallery-elem-html5-video-" + this.id).length ? b("#html5gallery-elem-html5-video-" + this.id, this.container).get(0).pause() : (a = this.getFlashMovieObject("html5gallery-elem-video-flash-" +
                    this.id)) && "function" === typeof a.pauseVideo && a.pauseVideo() : 9 == a ? this.ytPlayer && "function" == typeof this.ytPlayer.pauseVideo && this.ytPlayer.pauseVideo() : 10 == a ? this.vimeoPlayer && this.vimeoPlayer.api("pause") : b("video", this.container).length && b("video", this.container).get(0).pause()
            },
            ...
            showYoutube: function(a) {
                ...
                if (ASYouTubeIframeAPIReady && !this.options.isMobile && !this.options.isIE6 &&
                    ...
                    var l = this.getYoutubeParams(this.elemArray[this.curElem][2]),
                        l = b.extend({
                            html5: 1,
                            controls: j.options.videohidecontrols ? "0" : "1",
                            showinfo: j.options.videohidecontrols ? "0" : "1",
                            autoplay: a ? 1 : 0,
                            rel: 0,
                            wmode: "transparent"
                        }, l);
                ...
                } else f = this.prepareYoutubeHref(f), a && (f = 0 > f.indexOf("?") ? f + "?autoplay=1" : f + "&autoplay=1"), f = 0 > f.indexOf("?") ? f + "?wmode=transparent&rel=0" : f + "&wmode=transparent&rel=0", j.options.videohidecontrols && (f += "&controls=0&showinfo=0"), b("#html5gallery-elem-video-" + this.id, c).html("<iframe width='" + e + "' height='" + d + "' src='" + f + "' frameborder='0' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>");
                this.options.googleanalyticsaccount && window._gaq && window._gaq.push(["_trackEvent", "Video", "Play", this.elemArray[this.curElem][2]])
            },
            ...
            embedHTML5Video: function(a, c, d, e, f, j, l, g) {
                ...
                a.html("<div class='html5gallery-elem-video-container-" + this.id + "' style='position:relative;display:block;background-color:#000;width:100%;height:100%;'><video id='html5gallery-elem-html5-video-" + this.id + "'  width='100%' "+muted+" height='100%'" + (this.options.nativehtml5controls &&
                ...
                !this.options.nativehtml5controls && !this.options.videohidecontrols && (b("video", a).data("src", e), b("video", a).data("hd", f), b("video", a).data("ishd", this.isHd), b("video", a).addHTML5VideoControls(this.options.skinfolder, this, "#html5gallery-elem-html5-video-" + this.id, !1, !1, 1, this.options.fullscreennativecontrols,
                    this.options.html5videonodownload, null));
            ...
            embedFlash: function(a, b, d, e, f, j, k) {
                ...
                } else a.html("<div class='html5gallery-elem-error-" + this.id + "' style='display:block; position:absolute; text-align:center; width:" + this.options.width +
        ...
        this.each(function() {
            ...
            if ((!b(this).data("donotinit") || k && k.forceinit) && !b(this).data("inited")) {
                ...
                var h = {
                    ...
                    z = "vertical" == this.options.skin ? b.extend(z,
                ...
                "/" != this.options.skinfolder.charAt(0) && ("http:" != this.options.skinfolder.substring(0, 5) &&
                    "https:" != this.options.skinfolder.substring(0, 6)) && (this.options.skinfolder = this.options.jsfolder + this.options.skinfolder);
                h = ["bgimage", "playvideoimage", "playvideothumbimage"];
                ...
                h = f.length;
                for (c = 0; 5 > c; c++) f = f.slice(0, h - 9 + c) + f.slice(h - 8 + c); - 1 != this.options.htmlfolder.indexOf(f) && (this.options.fv = !1);
                h = b(window).width();
...
function HTML5GallerySWFObjectFunc() {
    ...
    function m(a) {
        if (typeof v.addEventListener != f) v.addEventListener("load", a, !1);
        else if (typeof r.addEventListener != f) r.addEventListener("load", a, !1);
        else if (typeof v.attachEvent != f) {
            var b = v;
    ...
    function A(a, c, d, j) {
        ...
        if (h) {
            ...
            j = "MMredirectURL=" + v.location.toString().replace(/&/g, "%26") + "&MMplayerType=" +
    ...
    function c(a, b, c, d) {
        if (!p.ie || !p.mac) {
            ...
            if (e) {
                ...
                d && (N = w = null);
                if (!w ||
                    N != c) d = r.createElement("style"), d.setAttribute("type", "text/css"), d.setAttribute("media", c), w = e.appendChild(d), p.ie && (p.win && typeof r.styleSheets != f && 0 < r.styleSheets.length) && (w = r.styleSheets[r.styleSheets.length - 1]), N = c;
                p.ie && p.win ? w && typeof w.addRule == j && w.addRule(a, b) : w && typeof r.createTextNode != f && w.appendChild(r.createTextNode(a + " {" + b + "}"))
            }
        }
    }
    ...
    if (typeof I.plugins != f && typeof I.plugins["Shockwave Flash"] ==
        j) {
        if ((y = I.plugins["Shockwave Flash"].description) && !(typeof I.mimeTypes != f && I.mimeTypes[l] && !I.mimeTypes[l].enabledPlugin)) $ = !0, P = !1, y = y.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), L[0] = parseInt(y.replace(/^(.*)\..*$/, "$1"), 10), L[1] = parseInt(y.replace(/^.*\.(.*)\s.*$/, "$1"), 10), L[2] = /[a-zA-Z]/.test(y) ? parseInt(y.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0
    } else if (typeof v.ActiveXObject != f) try {
        var H = new ActiveXObject("ShockwaveFlash.ShockwaveFlash");
        if (H && (y = H.GetVariable("$version"))) P = !0, y = y.split(" ")[1].split(","),
            L = [parseInt(y[0], 10), parseInt(y[1], 10), parseInt(y[2], 10)]
    } catch (X) {}
    p = {
        w3: U,
        pv: L,
    ...
    return {
        ...
        expressInstallCallback: function() {
            if (E) {
                var a = e(g);
                a && D && (a.parentNode.replaceChild(D, a), T && (d(T, !0), p.ie && p.win && (D.style.display = "block")), W && W(q));
                E = !1
            }
        }
    }
