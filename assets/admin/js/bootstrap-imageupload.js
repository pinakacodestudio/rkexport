...
(function($) {
    ...
    function resetFileTab($fileTab,url,type) {
        ...
        if(type=='1'){
            ...
            $fileTab.find('.alert').remove();
            $fileTab.find('.btn:eq(0)').hide();
            $fileTab.find('img').attr('src',url+'../assets/img/profile/Male-Avatar.png');
        }else if(type=='4'){ // set default female image
            $fileTab.find('.alert').remove();
            $fileTab.find('.btn:eq(0)').hide();
            $fileTab.find('img').attr('src',url+'../assets/img/profile/Female-Avatar.png');
        }else{
            $fileTab.find('.alert').remove();
            $fileTab.find('img').attr('src',url+'../assets/img/noimage.jpg');
