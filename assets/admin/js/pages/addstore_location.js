...
function checkvalidation(){
  ...
  var isvalidcontactperson = isvalidemail = isvalidmobileno = isvalidlink = 1;
    ...
    if(ACTION==0){
      ...
      $.ajax({
        ...
        success: function(response){
          if(response==1){
            new PNotify({title: "store location details successfully added.",styling: 'fontawesome',delay: '3000',type: 'success'});
            //resetdata();
            ...
            new PNotify({title: 'store location details not added !',styling: 'fontawesome',delay: '3000',type: 'error'});
          }
        },
        error: function(xhr) {
      ...
      var uurl = SITE_URL+"store-location/updatestore-location";
