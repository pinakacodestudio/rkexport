...
$(document).ready(function() {
  ...
  $('#datepicker-range').datepicker({
    ...
    oTable = $('#paymentreceipttable').DataTable({
      "language": {
        "lengthMenu": "_MENU_"
      },
      "pageLength": 10,
     /*  "scrollCollapse": true,
      ...
      "ajax": {
        "url": SITE_URL+"payment-receipt/listing",
        "type": "POST",
        "data": function ( data ) {
...
function changestatus(status, id){
  var uurl = SITE_URL+"payment-receipt/update-status";
  if(id!=''){
...
function checkvalidationforrejectionreceipt(){
...
function checkvalidationreceipt(){
...
function printPaymentReceipt(id){
  ...
  var uurl = SITE_URL + "payment-receipt/printPaymentReceipt";
  $.ajax({
    url: uurl,
    type: 'POST',
    data: {id:id},
