    ...
    var datahtml = '<div class="countinvoice" id="countinvoice'+rowcount+'">\
                    <div class="row m-n">\
                        ...
                        <div class="col-md-1 pt-md">\
                            <button type="button" class="btn btn-default btn-raised remove_invoice_btn m-n" onclick="removetransaction('+rowcount+')" style="padding: 3px 8px;"><i class="fa fa-minus"></i></button>\
