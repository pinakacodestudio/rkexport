    ...
    producthtml = '<tr class="countproducts" id="quotationproductdiv'+divcount+'">\
                        ...
                        <td style="'+discount+'">\
                            <div class="form-group" id="discount'+divcount+'_div">\
                                <div class="col-md-12">\
                                    <input type="text" class="form-control discount" id="discount'+divcount+'" onkeypress="return decimal_number_validation(event, this.value)" name="discount[]" value="" div-id="'+divcount+'" '+allowdiscount+'>	\
                                    <input type="hidden" value="" id="orderdiscount'+divcount+'">\
                                </div>\
                            </div>\
                            <div class="form-group" id="discountinrs'+divcount+'_div">\
                                <div class="col-md-12">\
                                    <input type="text" class="form-control discountinrs" id="discountinrs'+divcount+'" name="discountinrs[]" value="" div-id="'+divcount+'" onkeypress="return decimal_number_validation(event, this.value)" '+allowdiscount+'>\
                                </div>\
                            </div>\
                        </td>\
                        <td>\
                            <div class="form-group" id="tax'+divcount+'_div" style="'+editrate+'">\
                                <div class="col-md-12">\
