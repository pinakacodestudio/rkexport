                ...
                success: function(data) {
                    if (data == 0) {
                        ...
                        if (data == currentdids.length) {
                            ...
                            swal({
                                    title: data + ' ' + ucwords(name) + ' is used in other. So, you can not delete it. Still you want to delete remaining ' + name + '?',
                                    type: "warning",
                                    showCancelButton: true,
                                    confirmButtonColor: "#DD6B55",
                                    confirmButtonText: "Yes, delete it!",
                            ...
                            swal({
                                    title: data + ' ' + ucwords(name) + ' are used in other. So, you can not delete it. Still you want to delete remaining ' + name + '?',
                                    type: "warning",
                                    showCancelButton: true,
                                    confirmButtonColor: "#DD6B55",
                                    confirmButtonText: "Yes, delete it!",
...
function verifyemail(email) {
    swal({
            title: 'Are you sure to send verification mail?',
            type: "warning",
            showCancelButton: true,
            confirmButtonColor: "#DD6B55",
